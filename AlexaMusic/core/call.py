    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**Tidak ada obrolan video aktif yang ditemukan**\n\nPastikan Anda telah memulai obrolan video."
                )
            ...
            raise AssistantErr(
                "**Asisten sudah berada di obrolan video**\n\nSistem bot musik mendeteksi bahwa asisten sudah berada di obrolan video, jika masalah ini terus berlanjut, mulai ulang obrolan video dan coba lagi."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**Kesalahan server Telegram**\n\nSilakan matikan dan mulai ulang obrolan video lagi."
            )
